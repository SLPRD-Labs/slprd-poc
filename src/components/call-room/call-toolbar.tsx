        ...
        <div className="flex justify-center gap-4 border-t p-3">
            <button
                ...
                className={`rounded px-3 py-1 ${
                    localParticipant.isMicrophoneEnabled ? "bg-green-600" : "bg-gray-700"
                }`}
            >
                {localParticipant.isMicrophoneEnabled ? (
            ...
            <button
                ...
                className={`rounded px-3 py-1 ${
                    localParticipant.isCameraEnabled ? "bg-green-600" : "bg-gray-700"
                }`}
            >
            ...
            <button
                ...
                className={`rounded px-3 py-1 ${
                    localParticipant.isScreenShareEnabled ? "bg-green-600" : "bg-gray-700"
                }`}
            >
                {localParticipant.isScreenShareEnabled ? <ScreenShare /> : <ScreenShareOff />}
            </button>
        </div>
    );
};
